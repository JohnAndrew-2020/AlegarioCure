...
<head>
  ...
  * License: https://bootstrapmade.com/license/
  ...
  <style>
    ...
    .medtech-form input[type="submit"] {
      width: 100%;
      padding: 10px;
...
<div class="medtech-form">
  ...
  <form>
    ...
    <br><br><br><label>Doctor's Name:</label>
    ...
    <textarea name="findings" rows="5" required></textarea><br><br><br>
