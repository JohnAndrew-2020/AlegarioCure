...
<form>
    <h2>Laboratory Test Form</h2>
  <label for="test-id">Test ID:</label><br>
  <input type="text" id="test-id" name="test-id" required><br><br>

  <label for="request-id">Request ID:</label><br>
  <input type="text" id="request-id" name="request-id" required><br><br>
  ...
  <label for="test-date">Test Date:</label><br>
  <input type="date" name="test-date" required><br><br><br><br>
   
  

  <label for="prepared-by">Prepared By:</label><br>
  <input type="text" id="prepared-by" name="prepared-by" required><br><br>
