...
<p>Surgery schedulers play an important role in the medical field by coordinating and scheduling surgery <br>appointments for patients. They work closely with surgeons, patients, and medical staff to ensure that all surgery appointments are made in a timely and efficient manner. Surgery schedulers must have excellent communication and organizational skills in order to be successful in their role.
</p>
</div>
...
<div class="module02" style="background-image: url('img/hmo01.png')">
  ...
  <a href="patient_info.php" class="button button1">Click Here</a></button>
</div>
<br><br>


<div class="module02" style="background-image: url('img/hmo01.png')">
  <h2>View Patient Treatment</h2>
  <i class="fas fa-user-circle"></i>
  
  <a href="list_of_surgeon.php" class="button button1">Click Here</a></button>
</div>
<br>
