...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-heading">Dashboard Medtech</li>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Dashboard Medtech</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.php">Home</a></li>
          <li class="breadcrumb-item active">Dashboard medtech</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
...
document.addEventListener("DOMContentLoaded", function() {
  alert("Welcome to Nutritionist Dashboard😉✔");
});
   </script>
