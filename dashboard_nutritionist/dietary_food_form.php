...
.button2 {background-color: #fa5f5e;} /* Blue */
...
<br><br>
    ...
    <table id="breakfast">
      ...
      <tr>
        <td></td>
        <td></td>
        <td>&nbsp;<a id="addBreakfast" href="" class="button button1">Add</a></button>&nbsp;&nbsp;&nbsp;<a id="removeBreakfast" href="" class="button button2">Remove</a></button></td>
        <!--<td><button id="addBreakfast">Add</button><button id="removeBreakfast">Remove</button></td>----->
      </tr>
    </table>
    <h2>Lunch</h2>
    <table id="lunch">
      ...
      <tr>
        <td></td>
        <td></td>
        <td>&nbsp;<a id="addLunch" href="" class="button button1">Add</a></button>&nbsp;&nbsp;&nbsp;<a id="removeLunch" href="" class="button button2">Remove</a></button></td>
        <!--<td><button id="addLunch">Add</button><button id="removeLunch">Remove</button></td>-------->
      </tr>
    </table>
    <h2>Dinner</h2>
    <table id="dinner">
      ...
      <tr>
        <td></td>
        <td></td>
        <td>&nbsp;<a id="addDinner" href="" class="button button1">Add</a></button>&nbsp;&nbsp;&nbsp;<a id="removeDinner" href="" class="button button2">Remove</a></button></td>
        <!--<td><button id="addDinner">Add</button><button id="removeDinner">Remove</button></td>------->
      </tr>
    </table>
