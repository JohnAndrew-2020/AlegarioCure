...
<center><p>An HMO is a health maintenance organization, and is a type of health insurance. HMO plans are a type of managed care plan. 
  <br>Insurance plans are a way to pay for health care. HMO plans are a type of health insurance plan that contracts with medical providers, such as doctors, hospitals, and other health care providers to provide care for members at a set price.
</p></center>
</div>
<br>
<br>
...
<div class="module02" style="background-image: url('img/request.png')">
  <h2>Request</h2>
  <i class="fas fa-user-circle"></i>
  
  <a href="request.php" class="button button1">Click Here</a></button>
</div>
<br><br>
...
<div class="module02" style="background-image: url('img/hmo01.png')">
  ...
  <a href="application_form.php" class="button button1">Click Here</a></button>
</div>
<br>
