...
<div class="module" style="background-image: url('img/dashhhh.jpg')">
  ...
  <br><br><br>
  <a href="diet_management.php" class="button button1">Go back</a></button>
</div>
<br>
<br>
<br>
...
<form>
  ...
  <!-- Create the list of foods dropdown menu -->
  <label for="foods">Foods:</label><br>
