...
<hr>
<button class="button button002">Add new Patient</button>
<br><br>
 <!-------------- Table for outpatient Treatment ----------------------->
<table>
  <tr>
    <th>Outpatient ID</th>
    <th>Patient ID</th>
  ...
  <tr>
    ...
    <td style="background-color: #d3d3d3">
      <button class="button button001">Edit</button>
      <button class="button button002">Add</button>
      <button class="button button003">Remove</button>
    </td>
  </tr>               
    <tr>
    <td>OP001</td>
