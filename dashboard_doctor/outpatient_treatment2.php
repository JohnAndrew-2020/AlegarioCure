...
<div class="module01" style="background-image: url('img/2a9a8c_9a051c81cf8240108fbba9fd012516baf000.jpg')">
  <h2>About this page</h2
<center><p>trackless the patient’s treatment, programs, rehabilitation, personal care, &nbsp; <br> homecare medications for the outpatient who need extra care and attention.
</p></center>
</div>
<br>
<br>
<br>
<div class="module02" style="background-image: url('img/treatment01.png')">
  <h2>Outpatient List</h2>
  <i class="fas fa-user-circle"></i>
  
  <a href="outpatient_list.php" class="button button1">Click Here</a></button>
</div>
<br>
<br>
<div class="module02" style="background-image: url('img/treatment02.png')">
  <h2>Outpatient treatment</h2>
  <i class="fas fa-user-circle"></i>
  
  <a href="outpatient_treatment.php" class="button button1">Click Here</a></button>
</div>
<br>
