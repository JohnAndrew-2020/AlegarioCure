...
<form>
  ...
  <label for="result-id">Result ID:</label><br>
  <input type="text" id="result-id" name="result-id"><br>
  <label for="test-id">Test ID:</label><br>
  <input type="text" id="test-id" name="test-id"><br>
  <label for="result">Result:</label><br>
  <textarea id="result" name="result" rows="4" cols="50"></textarea><br>
  <label for="release-date">Release Date:</label><br>
  <input type="text" id="release-date" name="release-date"><br>
  <label for="examined-by">Examined by:</label><br>
  <input type="text" id="examined-by" name="examined-by"><br><br>
