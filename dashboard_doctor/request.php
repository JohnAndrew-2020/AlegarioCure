...
<form>
    ...
    <input type="text" id="requisition-id" name="requisition-id"><br>
    <label for="equip-id">Equipment ID:</label><br>
    <input type="text" id="equip-id" name="equip-id"><br>
    <label for="tools-id">Tools ID:</label><br>
    <input type="text" id="tools-id" name="tools-id"><br>
    ...
    <input type="text" id="test-id" name="test-id"><br><br>
